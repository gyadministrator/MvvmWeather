package com.android.custom.weather.weather.viewmodel;
...
import com.android.custom.weather.http.RetrofitManager;
import com.android.custom.weather.weather.model.WeatherData;
import com.android.custom.weather.weather.model.WeatherInfo;
import com.android.custom.weather.weather.request.QueryWeatherRequest;
        ...
        mCall.enqueue(new Callback<WeatherData>() {
            ...
            public void onResponse(Call<WeatherData> call, Response<WeatherData> response) {
                ...
                if (response.body() != null) {
                    weatherInfo = response.body().getWeatherinfo();
